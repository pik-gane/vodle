var WorkerThread = (function (exports) {
  ...
  function getPreviousElementSibling(node) {
    var parentNodes = node.parentNode && node.parentNode.childNodes;

    if (!parentNodes) {
      return null;
    }

    for (var i = parentNodes.indexOf(node) - 1; i >= 0; i--) {
      var _node = parentNodes[i];
  ...
  function getNextElementSibling(node) {
    ...
    for (var i = parentNodes.indexOf(node) + 1; i < parentNodes.length; i++) {
      var _node2 = parentNodes[i];
  ...
  */
  ...
  var DOMTokenList = /*#__PURE__*/function () {
    ...
    _createClass(DOMTokenList, [{
      ...
      value: function add() {
        ...
        /* tokens */
        ].length].concat(_toConsumableArray(Array.from(new Set(this[43
        /* tokens */
        ].concat(tokens))))));
      ...
      value: function replace(token, newToken) {
        ...
        /* tokens */
        ].length].concat(_toConsumableArray(Array.from(set))));
  ...
  var Element = /*#__PURE__*/function (_ParentNode) {
    ...
    function Element(nodeType, localName, namespaceURI, ownerDocument, overrideIndex) {
      ...
      _this._classList = void 0;
      _this.localName = void 0;
      _this.attributes = [];
      _this.namespaceURI = void 0;
      _this.style_ = void 0;
      _this.kind = void 0;
  ...
  */
  ...
  var Document = /*#__PURE__*/function (_Element) {
    ...
    function Document(global) {
      ...
      _this.defaultView = void 0;
      _this.documentElement = void 0;
      _this.body = void 0;
      _this.postMessage = void 0;
      _this.addGlobalEventListener = void 0;
      _this.removeGlobalEventListener = void 0;
      _this[58
      /* allowTransfer */
      ] = true;
