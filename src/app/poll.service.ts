...
export class Poll {
  ...
  public get db_other_server_url(): string { return this.G.D.getu('poll.'+this._pid+'.db_other_server_url'); }
  public set db_other_server_url(value: string) { 
    if (this.state=='draft') this.G.D.setu('poll.'+this._pid+'.db_other_server_url', value); 
  }

  public get db_other_password(): string { return this.G.D.getu('poll.'+this._pid+'.db_other_password'); }
  public set db_other_password(value: string) { 
    if (this.state=='draft') this.G.D.setu('poll.'+this._pid+'.db_other_password', value); 
  }

  // poll password and user's voter id will be autogenerated, so it is read-only:

  public get password(): string { return this.G.D.getu('poll.'+this._pid+'.password'); }
  public get vid(): string { return this.G.D.getu('poll.'+this._pid+'.vid'); }
  ...
  public get due(): Date {
    let due_str = this.G.D.getp(this, 'due'); 
