...
//      this.G.D.setp(pid, 'pid', pid);
  ...
  /** whether the user moved this (ended) poll into the archive section of
   *  "my polls" (issue #83); archived polls are kept instead of being
   *  deleted locally some time after their end */
