...
| 8/9 — Plan 2, track A (Matrix data path) | **in progress** (2026-09-10) | A1 #324 options added to a running poll reach the others (PR #335); A3 #325 server-confirmed close and final read, with the two-phase close of A5 #334 (this branch); A2 #326 and the bot's grace/quiet periods landed with PR #323. Next: A4 #329 (partition test). |
...
Session 8: A1 — done 2026-09-10 (A2 is done too). Session 9: A3 + A5 — done 2026-09-10. Next: A4 (the partition test).
