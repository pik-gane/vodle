...
Session 10: B1 + B2 — done 2026-09-10 (B1 except the owner's decisions). Session 11: B3 (after the owner's decision) + B5. Session 12: B4 together with D1 (guest login with later account migration, decided on #193).
