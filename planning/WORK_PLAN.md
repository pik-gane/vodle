...
| 8 — Plan 2, track A (Matrix data path) | **in progress** (2026-09-10) | A1 #324 options added to a running poll reach the others (this branch); A2 #326 offline replay within seconds and A5 #334 the guard bot's grace and quiet periods landed with PR #323. Next: A3 #325 (final tally from server state) with the two-phase close of #334, then A4 #329. |
...
Session 8: A1 — done 2026-09-10 (A2 is done too). Session 9: A3 + A5 (the same code: what the final tally reads, and how the close is sequenced). Session 9b: A4.
