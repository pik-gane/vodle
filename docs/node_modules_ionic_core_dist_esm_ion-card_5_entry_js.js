...
/* harmony import */ var _theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./theme-01f3f29c.js */ 71882);
...
const Card = class {
  ...
  componentWillLoad() {
    this.inheritedAriaAttributes = (0,_helpers_78efeec3_js__WEBPACK_IMPORTED_MODULE_1__.h)(this.el, ['aria-label']);
  }
  isClickable() {
  ...
  renderCard(mode) {
    ...
    if (!clickable) {
      return [(0,_index_527b9e34_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)];
    }
    const {
      href,
      routerAnimation,
    ...
    return (0,_index_527b9e34_js__WEBPACK_IMPORTED_MODULE_0__.h)(TagType, Object.assign({}, attrs, inheritedAriaAttributes, {
      class: "card-native",
      part: "native",
      disabled: this.disabled,
      onClick: ev => (0,_theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_2__.o)(href, ev, routerDirection, routerAnimation)
    }), (0,_index_527b9e34_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null), clickable && mode === 'md' && (0,_index_527b9e34_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-ripple-effect", null));
  }
  render() {
