...
/* harmony import */ var _data_cb72448c_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./data-cb72448c.js */ 47101);
...
const DatetimeButton = class {
  constructor(hostRef) {
    ...
    this.setDateTimeText = () => {
      ...
      const parsedDatetimes = (0,_data_cb72448c_js__WEBPACK_IMPORTED_MODULE_6__.q)(parsedValues.length > 0 ? parsedValues : [(0,_data_cb72448c_js__WEBPACK_IMPORTED_MODULE_6__.t)()]);
      /**
      ...
      const use24Hour = (0,_data_cb72448c_js__WEBPACK_IMPORTED_MODULE_6__.J)(locale, hourCycle); // TODO(FW-1865) - Remove once FW-1831 is fixed.
      ...
      switch (datetimePresentation) {
        case 'date-time':
        case 'time-date':
          const dateText = (0,_data_cb72448c_js__WEBPACK_IMPORTED_MODULE_6__.T)(locale, firstParsedDatetime);
          const timeText = (0,_data_cb72448c_js__WEBPACK_IMPORTED_MODULE_6__.K)(locale, firstParsedDatetime, use24Hour);
        ...
        case 'date':
          if (multiple && parsedValues.length !== 1) {
            ...
            this.dateText = (0,_data_cb72448c_js__WEBPACK_IMPORTED_MODULE_6__.T)(locale, firstParsedDatetime);
          }

          break;

        case 'time':
          this.timeText = (0,_data_cb72448c_js__WEBPACK_IMPORTED_MODULE_6__.K)(locale, firstParsedDatetime, use24Hour);
          break;

        case 'month-year':
          this.dateText = (0,_data_cb72448c_js__WEBPACK_IMPORTED_MODULE_6__.G)(locale, firstParsedDatetime);
          break;

        case 'month':
          this.dateText = (0,_data_cb72448c_js__WEBPACK_IMPORTED_MODULE_6__.S)(locale, firstParsedDatetime, {
            month: 'long'
          });
          break;
    ...
    this.waitForDatetimeChanges = /*#__PURE__*/(0,_home_runner_work_vodle_vodle_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        datetimeEl
      } = _this;
    ...
    this.handleDateClick = /*#__PURE__*/function () {
      var _ref2 = (0,_home_runner_work_vodle_vodle_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
        const {
          datetimeEl,
          datetimePresentation
        } = _this;
    ...
    this.presentOverlay = /*#__PURE__*/function () {
      var _ref3 = (0,_home_runner_work_vodle_vodle_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev, needsPresentationChange, triggerEl) {
        const {
          overlayEl
        } = _this;
