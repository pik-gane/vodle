...
const Spinner = class {
  ...
  getName() {
    const spinnerName = this.name || _ionic_global_ca86cf32_js__WEBPACK_IMPORTED_MODULE_2__.c.get('spinner');
  ...
  render() {
    var _a;
    const self = this;
    const mode = (0,_ionic_global_ca86cf32_js__WEBPACK_IMPORTED_MODULE_2__.b)(self);
    ...
    return (0,_index_527b9e34_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_527b9e34_js__WEBPACK_IMPORTED_MODULE_0__.e, {
      ...
      class: (0,_theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_1__.c)(self.color, {
        ...
        'spinner-paused': self.paused || _ionic_global_ca86cf32_js__WEBPACK_IMPORTED_MODULE_2__.c.getBoolean('_testing')
      }),
      role: "progressbar",
