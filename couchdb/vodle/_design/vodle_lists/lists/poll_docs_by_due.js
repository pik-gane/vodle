 ...
 * USAGE:
 * on the command line:
 * curl -X GET "http://admin:password@localhost:5984/vodle/_design/vodle_lists/_list/poll_docs_by_due/vodle_views/poll_due_doc_by_doc_id?include_docs=true&before=YYYY-MM-DD" | curl -X POST --data-binary @- -H 'Content-Type: application/json' "http://admin:password@localhost:5984/vodle/_purge"
